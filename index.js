...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Ensure the button becomes visible after 5 seconds
  setTimeout(() => {
      openModalButton.classList.remove("hidden");
      openModalButton.style.display = "flex"; // Show the button
  }, 5000);
  


document.getElementById('merrywrap').addEventListener('click', function () {
  // Change the background image of the body when the box is clicked
  document.body.style.backgroundImage = "url('aesthetic.jpg')";
});
...
"background-image 1s ease-in-out";
  ...
  openModalButton.addEventListener("click", () => {
      ...
      openModalButton.style.display = "none"; // Hide the button
      launchConfetti();
  });
...
// Add an event listener to trigger confetti on button click
button.addEventListener('click', () => {
      // Confetti blast configuration
      confettiInstance({
        particleCount: 150, // Number of confetti particles
        startVelocity: 30,  // Initial velocity
        spread: 360,        // Spread angle (360 for full circle)
        origin: { x: 0.5, y: 0.5 }, // Start from center of screen
        colors: ['#ff0a54', '#ff477e', '#ff7096', '#ff85a1', '#fbb1bd'], // Custom colors
      });
    });
